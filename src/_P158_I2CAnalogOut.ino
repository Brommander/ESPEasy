  ...
  case PLUGIN_WRITE:
  {
    ...
    //if (cmd.equalsIgnoreCase(F(CMD_NAME)) || cmd.equalsIgnoreCase(F("TaskValueSet")))
    {
      ...
      { // Nur wenn Uebertragung keinen Fehler hat Wert eintragen
        ...
        case 0:
          P158_ValueCh0 = value;
          UserVar[event->BaseVarIndex + 0] = P158_ValueCh0;
          break;
        case 1:
          P158_ValueCh0 = value;
          UserVar[event->BaseVarIndex + 1] = P158_ValueCh1;
          break;
        case 2:
          P158_ValueCh0 = value;
          UserVar[event->BaseVarIndex + 2] = P158_ValueCh2;
          break;
        case 3:
          P158_ValueCh0 = value;
          UserVar[event->BaseVarIndex + 3] = P158_ValueCh3;
          break;
        }
      }
      else
